...
function cloudServices() {
  ...
  return (
    ...
    <div className="bg-cover bg-center h-screen w-72 h-60
         background-image: url('https://s7ap1.scene7.com/is/image/TCSCOMprod/modernized-underwriting-platform-insurance-solution-cloud?wid=1900&hei=727&dpr=off') ;">
...
<section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Our approach</h1>
    </div>
...
<section className="text-gray-600 body-font">
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <p className="mb-8 leading-relaxed">No matter where you are on your cloud journey, <br/>we can help you get maximum value from it.
...
{/* benefits section */}
    <section className='bg-white'>
      <h3>Benefits</h3>
      <h2>Future-proof your business with solutions tailored for you.</h2>
      <ul>

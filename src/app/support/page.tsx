            ...
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                ...
                <div className="flex-grow">
                  <h2 className="text-white title-font font-medium">Email-Us</h2>
                  <p className="text-white">Info@greatertechhub.com</p>
                </div>
              </div>
            </div>
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                ...
                <div className="flex-grow">
                  <h2 className="text-white title-font font-medium">Text-Us</h2>
                  <p className="text-white">+91-9588160069</p>
                </div>
              </div>
            </div>
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                ...
                <div className="flex-grow">
                  <h2 className="text-white title-font font-medium">Call Now</h2>
                  <p className="text-white">Available via phone at 24×7.</p>
                </div>
              </div>
            </div>
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                ...
                <div className="flex-grow">
                  <h2 className="text-white title-font font-medium">Chat Now</h2>
                  <p className="text-white">Click to live chat</p>
                </div>
              </div>
            </div>
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                ...
                <div className="flex-grow">
                  <h2 className="text-white title-font font-medium">Go Online</h2>
                  <p className="text-white">Connect to support through our portal</p>
                </div>
              </div>
            </div>
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                ...
                <div className="flex-grow">
                  <h2 className="text-white title-font font-medium">Mobile</h2>

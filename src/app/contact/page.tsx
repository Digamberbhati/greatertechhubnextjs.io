        ...
        <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
          ...
          <div className="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
            ...
            <ul className="mt-16 space-y-8">
              <li className="flex items-center">
                ...
                <a href="javascript:void(0)" className=" text-sm text-gray-100 ml-4">
              ...
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" fill='#fff' viewBox="0 0 368.16 368.16">
                ...
                <a href="javascript:void(0)" className=" text-sm text-gray-100 ml-4">
                Office No.12, 3rd FLoor Krishna Palace
          ...
          <div className="p-4 lg:col-span-2">
            <form>
              ...
              <button type="button"
                className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide text-white bg-gray-800 hover:bg-transparent duration-300 ">

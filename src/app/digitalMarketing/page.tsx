...
function digitalMarketing() {
  return (
        ...
        <div>
          <div className="h-[100vh] relative w-full bg-green flex flex-col items-center justify-center overflow-hidden rounded-md">
...
<div>
    <section className="text-gray-400 bg-gray-900 body-font mt">
  <div className="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
    <img className="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded " alt="hero" src="https://dummyimage.com/720x600" width={480} height={600}/>

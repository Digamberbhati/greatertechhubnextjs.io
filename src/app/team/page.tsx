          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8 max-md:justify-center mt-12">
            <div className="border rounded-md overflow-hidden max-md:max-w-[300px] hover:scale-110 duration-500">
              <Image 
                ...
                width={500} 
                height={300} 
                className="w-full h-60 object-contain object-top bg-gray-200 hover:scale-100"
              />
              ...
              <div className="p-4">
                ...
                <div className="mt-4">
                  <p className="text-gray-400 text-sm leading-relaxed">Director of the company</p>
                </div>
            ...
            <div className="border rounded-md overflow-hidden max-md:max-w-[300px] hover:scale-110 duration-500">
              ...
              <div className="p-4">
                ...
                <div className="mt-4">
                  <p className="text-gray-400 text-sm leading-relaxed">2+ years of experience in website development</p>
                </div>
              </div>
            </div>
            ...
            <div className="border rounded-md overflow-hidden max-md:max-w-[300px] hover:scale-110 duration-500">
              ...
              <div className="p-4">
                ...
                <div className="mt-4">
                  <p className="text-gray-400 text-sm leading-relaxed">5+ years of experience.</p>
                </div>
              </div>
            </div>

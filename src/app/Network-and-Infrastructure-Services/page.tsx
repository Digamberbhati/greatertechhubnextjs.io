...
function NetworkAndInfrastructutre() {
  return (
    <div>
     <div>
        <img src='https://images.unsplash.com/photo-1469365556835-3da3db4c253b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fGNsb3VkJTIwc2VydmljZXN8ZW58MHx8MHx8fDA%3D' alt='image' height={100} width={1600}></img>

...
<div>
      <div>
        <img src='https://img.freepik.com/free-photo/inbound-marketingn-marketing-strategy-commerce-online-concept_53876-13722.jpg?t=st=1724428257~exp=1724431857~hmac=076a820a1b1593795b496cf4dc31a4889580ee9ecf96f0f7905af1b85b7b01b3&w=996' alt='image' height={500} width={1600}></img>
  ...
  <div className="flex">
    ...
    <div className="w-1/4 text-center px-6">
      <div className="bg-gray-300 rounded-lg flex items-center justify-center border border-gray-200">
        ...
        <div className="w-2/3 bg-gray-200 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step">
          <h2 className="font-bold text-sm">Project Planning</h2>
          <p className="text-xs text-gray-600">
          Discuss the proposal with the customer, make necessary adjustments, and finalize the agreement.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="w-1/4 text-center px-6">
      <div className="bg-gray-300 rounded-lg flex items-center justify-center border border-gray-200">
        ...
        <div className="w-2/3 bg-gray-200 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step">
          <h2 className="font-bold text-sm">Design and Development</h2>
          <p className="text-xs text-gray-600">
          Begin with the design phase, creating wireframes, prototypes, and architectural designs as required. Get customer approval before proceeding.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="w-1/4 text-center px-6">
      <div className="bg-gray-300 rounded-lg flex items-center justify-center border border-gray-200">
        ...
        <div className="w-2/3 bg-gray-200 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step">
          ...
          <p className="text-xs text-gray-600">
          Perform thorough testing, including unit testing, integration testing, and user acceptance testing (UAT).          </p>
        </div>
      </div>
    </div>
    ...
    <div className="w-1/4 text-center px-6">
      <div className="bg-gray-300 rounded-lg flex items-center justify-center border border-gray-200">
        ...
        <div className="w-2/3 bg-gray-200 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step">
          <h2 className="font-bold text-sm">Project Delivery</h2>
          <p className="text-xs text-gray-600">
          Deliver the final product, ensuring it meets all agreed-upon requirements. Obtain formal acceptance from the customer.          </p>
        </div>
      </div>
    </div>
...
<section className="text-white body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-white">Our Marketing Services</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-white">Our marketing agency is here to help you achieve maximum success. We offer a variety of services, from the conception and design of your brand, to the graphic design of your logo, website and e-commerce, up to the development of a digital strategy tailored for you and your audience. We are ready to accompany you in every step of the growth of your business</p>
    </div>
    <div className="flex flex-wrap -m-4">
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-text-white p-6 rounded-lg">
          <div className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-white mb-4">
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-6 h-6" viewBox="0 0 24 24">
              <path d="M22 12h-4l-3 9L9 3l-3 9H2"></path>
            </svg>
          </div>
          <h2 className="text-lg text-white font-medium title-font mb-2">Paid Advertising</h2>
          <p className="leading-relaxed text-base">Meta Ads, Google Ads, Linkedin Ads and Twitter Ads are a great way to instantly increase targeted traffic to your site.</p>
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-text-white p-6 rounded-lg">
          ...
          <h2 className="text-lg text-white font-medium title-font mb-2">Search Engine Optimization</h2>
          <p className="leading-relaxed text-base">We can help you rank higher on Google and generate organic traffic.</p>
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-white p-6 rounded-lg">
          ...
          <h2 className="text-lg text-white font-medium title-font mb-2">Sales Funnels</h2>
          <p className="leading-relaxed text-base">We can help you design the right funnel for your company to market, sell and deliver your products online.</p>
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-text-white p-6 rounded-lg">
          ...
          <h2 className="text-lg text-text-white font-medium title-font mb-2">Brand Identity</h2>
          <p className="leading-relaxed text-base">Grow your business by making it easily recognizable. Unique logos and customized communication.</p>
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-text-white p-6 rounded-lg">
          ...
          <h2 className="text-lg text-white font-medium title-font mb-2">Content Marketing</h2>
          <p className="leading-relaxed text-base">We can help you produce engaging content to help SEO, share on social or generate more leads.</p>
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-white p-6 rounded-lg">
          ...
          <h2 className="text-lg text-white font-medium title-font mb-2">Social Media Marketing</h2>
          <p className="leading-relaxed text-base">Create a dialogue with your customers as they spend their time online. Talk to them and amaze them with your news.</p>
        </div>
      </div>
    </div>
    {/* <button className="flex mx-auto mt-16 text-white bg-text-white border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Button</button> */}
  </div>
</section>
      ...
      <div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
        <div className="flex relative pb-12">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed">Discuss the proposal with the customer, make necessary adjustments, and finalize the agreement.</p>
          </div>
        </div>
        <div className="flex relative pb-12">
          <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed">Begin with the design phase, creating wireframes, prototypes, and architectural designs as required. Get customer approval before proceeding.</p>
          </div>
        </div>
        <div className="flex relative pb-12">
          <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed">Perform thorough testing, including unit testing, integration testing, and user acceptance testing (UAT)</p>
          </div>
        </div>
        <div className="flex relative pb-12">
          <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed">Deliver the final product, ensuring it meets all agreed-upon requirements. Obtain formal acceptance from the customer.</p>
          </div>
        </div>
      ...
      <section className="text-white-600 body-font">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center pl-24">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center ml-">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white-900">Book a meeting
            to get started
            </h1>
            <p className="mb-8 leading-relaxed">Speak to an expert to find out how Digital Consumer Intelligence will change the way you work.</p>

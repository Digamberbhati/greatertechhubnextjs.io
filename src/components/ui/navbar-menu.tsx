...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className=" lg:relative lg:right-1 lg:top-1  absolute right-8 top-5 rounded-md lg:rounded-full border z-[100] flex-col lg:flex-row  border-white/[0.5] bg-black shadow-input flex justify-center items-center gap-10 px-8 py-6 lg:w-full lg:px-32  "
    >
      {children}
    </nav>
  );
...
export const ProductItem = ({
  ...
  return (
    <Link href={href} className="flex z-50  space-x-2">
      <Image
        src={src}
        width={140}
        height={70}

...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className=" lg:relative absolute right-8 top-5 rounded-md lg:rounded-full border z-[100] flex-col lg:flex-row  border-white/[0.5] bg-black shadow-input flex justify-center gap-6 px-8 py-6 "
    >
      {children}
    </nav>
  );

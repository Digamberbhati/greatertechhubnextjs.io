...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className=" lg:relative lg:right-1 lg:top-1  absolute right-8 top-5 rounded-md lg:rounded-full  z-[100] flex-col lg:flex-row  shadow-input flex justify-center items-center gap-10  py-6 lg:w-full  "
    >
      {children}
    </nav>
  );

...
const Navbar = ({ className }: { className?: string }) => {
    ...
    return (
        <div className="flex items-center  justify-between bg-transparent backdrop-blur-lg sticky top-0 w-full h-13 px-8 py-0 z-100  text-[#F5EBEB] z-30">
           ...
           <div> 
            <Link href="/refer&earn" className="hidden lg:flex border border-zinc-600 h-6 justify-center items-center bg-black px-8 py-8 rounded-full hover:bg-transparent">
                Refer&Earn
            </Link>
            </div>
        </div>

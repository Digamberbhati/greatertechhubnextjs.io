...
function Footer1() {
  return (
    <div className='pb-4'>
      <footer className="bg-gray-950 pb-0">
        <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 scroll">
            <div>
              <h2>Location</h2>

              <div className='max-w-md mx-auto mt-6 leading-relaxed text-center text-gray-400 sm:max-w-xs sm:mx-0 sm:text-left'>
                      <div
                  ...
                  >
                    ...
                    <address className="-mt-0.5 not-italic text-white">
                      office No.12, 3rd Floor Krishna Palace <br />
          ...
          <li>
            ...
            >
              ...
              <div className="text-center sm:text-left">
                <p className="text-lg font-medium text-white">Legal Links</p>
              ...
              <div className="text-center sm:text-left">
                ...
                <nav className="mt-8">
                  <ul className="space-y-4 text-sm">
                    <li>
                      <a className="text-white transition hover:text-white/75" href="/careers">
                        Career
                      </a>
                    </li>

                    <li>
                      <a className="text-white transition hover:text-white/75" href="/event">
                        Events
                      </a>
                    </li>

                    <li>
                      <a className="text-white transition hover:text-white/75" href="/support">
                        Support
                      </a>
                    </li>
                  </ul>
